...
#################
  ...
  get 'games/skip_rating', to: 'game_desktop_admin#skip_rating', as: 'gda_skip_rating'
...
################
  ...
  post 'mobile/admin/after_wait', to: 'game_mobile_admin#after_wait', as: 'gma_after_wait'
  post 'mobile/admin/before_intro', to: 'game_mobile_admin#before_intro', as: 'gma_before_intro'
  get 'mobile/admin/intro', to: 'game_mobile_admin#intro', as: 'gma_intro'
  get 'mobile/admin/select_user', to: 'game_mobile_admin#choose_rating_user', as: 'gma_choose_rating_user'
  ...
  get 'mobile/admin/react', to: 'game_mobile_admin#react', as: 'gma_react'
  ...
  get 'mobile/admin/skip_rating', to: 'game_mobile_admin#skip_rating', as: 'gma_skip_rating'
...
###############
  ...
  get 'mobile/user/game/react', to: 'game_mobile_user#react', as: 'gmu_react'
  ...
  get 'mobile/user/game/skip_rating', to: 'game_mobile_user#skip_rating', as: 'gmu_skip_rating'
...
##########
  ...
  get 'rating/:rating_id', to: 'custom_rating#destroy', as: 'destroy_custom_rating'
  get 'admin/dash/customize/custom_rating/:rating_id', to: 'dash_admin#customize', as: 'dash_admin_custom_rating'
...
post 'ratings/:turn_id/user/new', to: 'rating_criteria#create_user_rating', as: "new_user_rating_criteria"
