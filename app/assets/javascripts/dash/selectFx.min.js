! function(e) {
    ...
    function s(e, s) {
        this.el = e, this.options = t({}, this.options), t(this.options, s), this._init()
    }
    s.prototype.options = {
        newTab: !1,
        stickyPlaceholder: !0,
        ...
        var e = "",
            t = function(e) {
                var t = "",
                    s = "",
                    l = "";
                return !e.selectedOpt || this.foundSelected || this.hasDefaultPlaceholder || (s += "cs-selected ", this.foundSelected = !0), (s+=e.getAttribute("data-class")) && (s += e.getAttribute("data-class")), e.getAttribute("data-link") && (l = "data-link=" + e.getAttribute("data-link")), "" !== s && (t = 'class="' + s + '" '), "<li " + t + l + ' data-option data-value="' + e.value + '"><span>' + e.textContent + "</span></li>"
            };
